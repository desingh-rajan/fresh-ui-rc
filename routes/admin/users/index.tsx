/**
 * Users List Page - Uses generic CRUD system
 */
...
export default define.page<typeof handler>(function UsersListPage({ data }) {
  const { items, config, error, errorStatus } = data;
  const response = items as ListResponse<User>;

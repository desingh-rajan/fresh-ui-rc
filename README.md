# Fresh Admin UI - tstack-kit Default UI Framework

## DRY, config-driven CRUD system for Fresh 2.2.0 + DaisyUI
...
# Login: dev-admin@example.com / DevPassword123!
```
...
This UI framework is designed for easy scaffolding:
